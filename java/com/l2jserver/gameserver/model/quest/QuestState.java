...
import com.l2jserver.Config; // PC Bang Points
import com.l2jserver.L2DatabaseFactory;
import com.l2jserver.gameserver.cache.HtmCache;
import com.l2jserver.gameserver.instancemanager.PcCafePointsManager; // PC Bang Points
...
import com.l2jserver.util.Rnd; // PC Bang Points
...
public final class QuestState
{
	...
	public void addExpAndSp(int exp, int sp)
	{
		...
		PcCafePointsManager.getInstance().givePcCafePoint(getPlayer(), (long) (exp * Config.RATE_QUEST_REWARD_XP)); // PC Bang Points
	}
	// PC Bang Points
