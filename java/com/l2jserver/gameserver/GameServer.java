...
public final class GameServer
{
	...
	public GameServer() throws Exception
	{
		...
		_log.log(Level.INFO, getClass().getSimpleName() + ": ################COPYRIGHT################## ");
		_log.log(Level.INFO, getClass().getSimpleName() + ": ###           L2Private 2022            ### ");
		_log.log(Level.INFO, getClass().getSimpleName() + ": ################COPYRIGHT################## ");
		_log.log(Level.INFO, getClass().getSimpleName());
		_log.log(Level.INFO, getClass().getSimpleName() + ": ############CONTACT INFORMATION############ ");
		_log.log(Level.INFO, getClass().getSimpleName() + ": ##   Forum:   under construction        ### ");
		_log.log(Level.INFO, getClass().getSimpleName() + ": ##   Website: under construction        ### ");
		_log.log(Level.INFO, getClass().getSimpleName() + ": ############CONTACT INFORMATION############ ");
	}
